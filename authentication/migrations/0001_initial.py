    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('production_head', 'Production Head'), ('supervisor', 'Supervisor'), ('rm_store', 'RM Store'), ('fg_store', 'FG Store')], max_length=50, unique=True)),
                ...
                ('restricted_departments', models.JSONField(blank=True, default=list, help_text='Departments this role can access', null=True)),
            ],
            options={
                'verbose_name': 'Role',
